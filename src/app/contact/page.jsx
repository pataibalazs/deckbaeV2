...
const ContactPage = () => {
  ...
  return (
    <div className="bg-gray-100 flex flex-col items-center">
      ...
      <main className="flex flex-col items-center p-6 bg-white shadow-md rounded-lg mt-10 mb-10 max-w-80 xs:max-w-md sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl 2xl:max-w-7xl w-full">
        <div className="bg-white w-full">
          <div className="mx-auto max-w-7xl mb-10 w-full">
            <div className="mx-auto max-w-5xl text-center">
              ...
              <div className="bg-white text-left w-full">
                {state.succeeded ? (
                      ...
                      <div>
                        ...
                        <div className="mt-2.5">
                          <input
                            ...
                            autoComplete="email"
                            required
                            className="block w-full rounded-md border-0 px-3.5 py-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-red-600 sm:text-sm sm:leading-6"
                          />
                          <ValidationError
                            prefix="Email"
                            field="email"
                      ...
                      <div>
                        ...
                        <div className="relative mt-2">
                          <select
                            id="product"
                            name="product"
                            className="block bg-white w-full rounded-md border-0 py-3 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-red-600 sm:text-sm sm:leading-6 appearance-none"
                          >
              ...
              <div className="mt-10 w-full mx-auto max-w-xl">
                <div className="bg-white border border-gray-200 p-4 sm:p-8 rounded-lg shadow-md transition-all duration-300 hover:shadow-lg w-full">
                  <div className="flex items-center justify-center mb-8">
                    <div className="mr-4 p-3 bg-red-100 rounded-full flex items-center justify-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          <p className="text-sm text-gray-500 text-left">Cím</p>
                          <p className="text-md font-medium text-gray-800 text-left">
                            2073 Tök, Fő u. 1, Magyarország
                          </p>
                        </div>
                      </div>
