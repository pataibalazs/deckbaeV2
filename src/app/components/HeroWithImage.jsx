  ...
  return (
    <div className="relative bg-white">
      <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-2 lg:px-0">
        <div className="px-6 pt-10 pb-24 sm:pb-32 lg:col-span-7 lg:px-8 lg:pt-16 lg:pb-48 xl:col-span-6">
          <div className="mx-auto max-w-lg lg:mx-0">
            ...
            <div className="mt-10 flex items-center gap-x-6">
              <Link
                href="/houses"
                className="rounded-md bg-red-600 px-6 py-3 text-lg font-semibold text-white shadow-xs hover:bg-red-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 transition-colors"
              >
                Kezdjük el!
              </Link>
              <Link
        ...
        <div className="relative lg:col-span-5 lg:-mr-0 xl:absolute xl:inset-0 xl:left-1/2 xl:bottom-1/4 xl:mr-0">
          <img
            alt="DECKBAE"
